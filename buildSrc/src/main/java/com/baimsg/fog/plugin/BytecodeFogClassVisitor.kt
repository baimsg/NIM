...
import com.baimsg.fog.ClassStringField
import com.baimsg.fog.IBytecodeFog
...
class BytecodeFogClassVisitor(
    ...
    open inner class StubMethodVisitor(api: Int, mv: MethodVisitor) : MethodVisitor(api, mv) {
        ...
        fun insertDecryptInstructions(originalValue: String?) {
            ...
            mv.visitTypeInsn(Opcodes.NEW, "com/baimsg/fog/xor/BytecodeFogImpl")
            mv.visitInsn(Opcodes.DUP)
            mv.visitMethodInsn(
                Opcodes.INVOKESPECIAL,
                "com/baimsg/fog/xor/BytecodeFogImpl",
                "<init>",
                "()V",
                false
            )
